...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', availableAt?: any | null, slug: string, title: string, lessonType: LessonType, id: string }> };
